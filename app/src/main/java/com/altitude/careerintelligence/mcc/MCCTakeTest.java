...
import com.altitude.careerintelligence.mcc.fragments.MCCTakeTestFragment;
...
public class MCCTakeTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcctake_test);
...
//        ExampleRequestQueue = Volley.newRequestQueue(this);
        ...
        session = new SessionManager(MCCTakeTest.this);
...
//        getAmount(token);
        ...
        tabLayout = (TabLayout) findViewById(R.id.test_tabs);
...
//        Toast.makeText(MCCPayment.this, ""+anyAmount, Toast.LENGTH_SHORT).show();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new MCCTakeTestFragment(), "Take Test");
        adapter.addFragment(new MCCViewResultFragment(), "View Result");
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    fragment=new MCCTakeTestFragment();
//                    Bundle bundle = new Bundle();
//                    bundle.putDouble("testAmount", status);
//                    fragment.setArguments(bundle);
                    break;
                case 1:
                    fragment=new MCCViewResultFragment();
